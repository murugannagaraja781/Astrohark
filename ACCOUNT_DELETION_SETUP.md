...
**URL**: `https://astrohark.com/delete-account.html`
...
**URL**: `https://astrohark.com/admin/deletion-requests.html`
...
### For Users:
1. Visit `https://astrohark.com/delete-account.html`
...
### For Admins:
1. Visit `https://astrohark.com/admin/deletion-requests.html`
...
```bash
curl -X POST https://astrohark.com/api/delete-account-request \
